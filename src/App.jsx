  ...
  if(!user){
    return (
      <div>
        ...
        <div>
        <input type="email"  placeholder='coloque aqui o seu email' value={email} onChange={e => setEmail(e.target.value)}/>
        <input type="password"  placeholder='coloque aqui o sua senha' value={senha} onChange={e => setSenha(e.target.value)}/>
